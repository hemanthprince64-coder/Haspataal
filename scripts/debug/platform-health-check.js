...
try {
  ...
  if (rbacCode.includes('requireHospitalTenant'))
    pass('RBAC: requireHospitalTenant (multi-tenant guard) present');
...
const apiClients = ['./doctor-portal/src/lib/api.ts', './hospital-hms/src/lib/api.ts'];
