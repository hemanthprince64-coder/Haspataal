...
async function runLifecycleTest() {
  ...
  try {
    ...
    const hospital =
      (await prisma.hospitalsMaster.findFirst()) ||
    ...
    const visit = await prisma.visit.create({
      data: {
        ...
        notes: {
          create: {
            content:
              'Patient has acute bronchitis. Prescribed antibiotics and rest. Monitor for breathing difficulty.',
            type: 'CLINICAL_NOTE',
          },
        },
      },
      ...
      data: [
        {
          ...
          dayNumber: 1,
          expectedSymptoms: 'Fever, Cough',
          markers: 'Rest',
          guidance: 'Fluid intake',
        },
        {
          careJourneyId: journey.id,
          dayNumber: 2,
          expectedSymptoms: 'Mild Fever',
          markers: 'Better appetite',
          guidance: 'Light walking',
        },
        {
          careJourneyId: journey.id,
          dayNumber: 4,
          expectedSymptoms: 'No Fever',
          markers: 'Clear lungs',
          guidance: 'Normal diet',
        },
      ],
    });
