...
async function testOnboarding() {
  ...
  try {
    ...
    console.log(
      `✅ Hospital registered with ID: ${newHospital.id}, Status: ${newHospital.verificationStatus}`,
    );
    ...
    if (loginResult) {
      ...
      console.log(
        '❌ Hospital login failed! (Note: The test checks password but register did not save it in Hospital!)',
      );
    }
  } catch (error) {
