...
app.post('/v1/appointments', requireAuth, rateLimiter, async (req, res) => {
...
app.patch('/v1/appointments/:id/status', requireAuth, rateLimiter, async (req, res) => {
...
app.patch('/v1/escalations/:id/acknowledge', requireAuth, requireRole('doctor', 'DOCTOR', 'hospital_admin', 'HOSPITAL_ADMIN', 'super_admin', 'SUPER_ADMIN'), rateLimiter, async (req, res) => {
