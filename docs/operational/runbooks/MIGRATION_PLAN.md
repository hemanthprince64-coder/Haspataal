...
- Proposal: `openspec/changes/six-engine-integration/proposal.md`
- Tasks: `openspec/changes/six-engine-integration/tasks.md`
- Detailed migration plan: `openspec/changes/six-engine-integration/migration-plan.md`
- Test plan: `openspec/changes/six-engine-integration/test-plan.md`
- Architecture notes: `openspec/changes/six-engine-integration/architecture.md`