...
export default async function AdminPage() {
    ...
    return (
        <div style={{ padding: '2rem', maxWidth: '1000px', margin: '0 auto' }}>
            <h1 style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '2rem' }}>🏥 Platform Admin: Hospital Verification</h1>
                ...
                {pendingHospitals.map(h => (
                    <div key={h.id} className="card" style={{ padding: '1.5rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <div>
                            ...
                            {h.lat && h.lng && <p style={{ fontSize: '0.8rem', color: 'blue' }}>Has Location ✅</p>}
                        </div>
