...
export class SearchCommandHandler {
    ...
    async handleIndexDocument(rawCommand, options) {
        ...
        }, options === null || options === void 0 ? void 0 : options.tx);
    }
    async handleDeleteDocument(rawCommand, options) {
        const command = DeleteDocumentCommandSchema.parse(rawCommand);
        const payload = command.payload;
        await this.searchService.delete(payload.entityId, payload.entityType, options === null || options === void 0 ? void 0 : options.tx);
    }
}
