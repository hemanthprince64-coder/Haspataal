...
export class PostgresSearchProvider {
    ...
    async autocomplete(text, options) {
        ...
        const results = await prisma.searchableEntity.findMany({
            where: Object.assign(Object.assign({ title: { startsWith: text, mode: 'insensitive' } }, (options.types ? { entityType: { in: options.types } } : {})), (options.hospitalId ? { hospitalId: options.hospitalId } : {})),
    ...
    async health() {
      ...
      `;
            ...
            return {
                status: 'healthy',
                documentCount: count,
                indexSizeBytes: Number(((_a = sizeResult[0]) === null || _a === void 0 ? void 0 : _a.size) || 0),
                queueDepth: outboxCount,
                lastIndexedAt: (lastIndexedResult === null || lastIndexedResult === void 0 ? void 0 : lastIndexedResult.updatedAt) || new Date(0),
            };
        }
        catch (error) {
            return {
