...
exports.canonicalEventEnvelopeSchema = zod_1.z.object({
  ...
  aggregate: zod_1.z.object({
    aggregateType: zod_1.z.string().nullable(),
    aggregateId: zod_1.z.string().nullable(),
  }),
...
function normalizeLegacyOutbox(record) {
  ...
  const aggregateType = firstPresent(
