...
export class OutcomeService {
  ...
  /**
   * Record the outcome of a referral consultation.
   * Supports: ADVICE_ONLY, TRANSFER_ACCEPTED, TRANSFER_DECLINED,
   *           FURTHER_FOLLOW_UP_REQUIRED, CLOSED
   */
  async recordOutcome(
  ...
  /**
   * Close a referral outcome report.
   */
