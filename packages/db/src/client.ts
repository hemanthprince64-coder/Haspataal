// ============================================================
// @haspataal/db — Shared Prisma client singleton for all apps
// ============================================================
//
// Usage:
...
//   - Soft-delete middleware (medical records never hard-delete)
//   - RLS session helper (withAuth) for multi-tenant isolation
// ============================================================
...
// Re-export Prisma namespace for transaction types etc.
