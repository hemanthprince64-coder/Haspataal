        ...
        <div style={{ flex: 1 }}>
          ...
          >
            ...
            {freshPatient.gender && (
              <span>
                ⚤{' '}
                {freshPatient.gender === 'M'
                  ? 'Male'
                  : freshPatient.gender === 'F'
                    ? 'Female'
                    : 'Other'}
              </span>
            )}
      ...
      {visits.length === 0 ? (
        <div className="card empty-state">
          ...
          <p className="empty-state-text">
            Book your first appointment to see your visit history here.
          </p>
              ...
              >
                <div style={{ flex: 1 }}>
                  ...
                  >
                    ...
                    <span
                      className={`badge ${isUpcoming ? 'badge-primary' : isCancelled ? 'badge-danger' : 'badge-success'}`}
                    >
                      {v.status}
                    </span>
                  </div>
                ...
                {isUpcoming && <ProfileActions visitId={v.id} />}
              </div>
            );
          })}
        </div>
