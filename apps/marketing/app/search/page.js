  ...
  return (
    <main className="container page-enter" style={{ padding: '2rem 1rem' }}>
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        <div className="pills-scroll">
          <Link
            href={`/search?city=${city}${query ? `&q=${query}` : ''}`}
            className={`pill ${!speciality ? 'pill-active' : 'pill-inactive'}`}
          >
            All
          </Link>
          {specialities.map((s) => (
            <Link
              ...
              className={`pill ${speciality === s ? 'pill-active' : 'pill-inactive'}`}
            >
              {s}
            </Link>
          ))}
            ...
            return (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    🏥 {hospital?.name || 'Unknown Hospital'} • 📍 {hospital?.city || city}
                  </p>
                  <div
                    style={{
                      display: 'flex',
                  ...
                  >
                    ...
                    <Link
                      href={`/book?doctorId=${doc.id}&hospitalId=${doc.hospitalId}`}
