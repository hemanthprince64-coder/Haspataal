          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  <Link href="/search" style={{ color: '#94a3b8', textDecoration: 'none' }}>
                    Find Doctors
                  </Link>
                  <Link href="/hospitals" style={{ color: '#94a3b8', textDecoration: 'none' }}>
                    View Hospitals
                  </Link>
                  <Link href="/profile" style={{ color: '#94a3b8', textDecoration: 'none' }}>
                    My Appointments
                  </Link>
            ...
            <div
              style={{ borderTop: '1px solid #334155', paddingTop: '1.25rem', textAlign: 'center' }}
            >
              <p style={{ fontSize: '0.8rem', color: '#64748b' }}>
                © {new Date().getFullYear()} Haspataal. All rights reserved. Built with 💙 for
                better healthcare.
              </p>
            </div>
          </footer>
