...
export default async function AdminDashboard() {
  ...
  if (!adminCookie) return redirect('/'); // Auth Check

  const stats = services.admin.getPlatformStats();
  const pendingCount = stats.pendingHospitals || 0;
    ...
    <div className="page-enter">
      ...
      {pendingCount > 0 && (
        ...
        >
          ...
          <a href="/dashboard/hospitals" style={{ color: 'var(--primary)', fontWeight: '600' }}>
            Review →
          </a>
        </div>
      )}
