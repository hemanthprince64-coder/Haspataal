      ...
      <body className={`${interClassName} bg-slate-950 text-white min-h-screen flex`}>
        ...
        <aside className="w-64 bg-gray-950 border-r border-gray-800 flex flex-col p-6 shrink-0">
          ...
          <nav className="flex flex-col gap-2 flex-1">
            <Link
              href="/"
              className="flex items-center gap-3 px-4 py-2 rounded-lg bg-violet-500/10 text-violet-400 font-medium text-sm"
            >
              <span>🛡️</span> Admin Dashboard
            </Link>
            <Link
              href="/hospitals"
              className="flex items-center gap-3 px-4 py-2 rounded-lg hover:bg-white/5 text-gray-400 hover:text-white text-sm transition-colors"
            >
          ...
          <div className="mt-auto">
            <div className="flex items-center gap-3 px-4 py-3 bg-gray-900 rounded-xl">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-violet-400 to-pink-600 flex items-center justify-center text-xs font-bold">
                A
              </div>
              <div>
