          ...
          {[
            {
              ...
              desc: 'Digitize walk-in and appointment-based OPD visits',
            },
            {
              icon: '👨‍⚕️',
              title: 'Doctor Management',
              desc: 'Add and manage your doctors and their schedules',
            },
            {
              icon: '📊',
              title: 'Reports & Analytics',
              desc: 'Track daily visits, revenue, and patient metrics',
            },
          ].map((f) => (
