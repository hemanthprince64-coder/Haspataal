  ...
  if (state?.success) {
    return (
      <div
        ...
        style={{ textAlign: 'center', padding: '2.5rem', borderLeft: '4px solid var(--success)' }}
      >
        ...
        <div
          className="card"
          style={{ textAlign: 'left', marginBottom: '1.5rem', background: '#f8fafc' }}
        >
          <h4 style={{ marginBottom: '0.75rem', fontWeight: '700', fontSize: '0.9rem' }}>
            💳 Receipt Summary
          </h4>
          <div
            style={{
