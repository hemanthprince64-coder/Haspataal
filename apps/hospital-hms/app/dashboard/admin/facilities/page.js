      ...
      <form onSubmit={handleSubmit} className="space-y-4 bg-white p-6 rounded shadow border">
        <div className="flex items-center gap-3">
          <input
            type="checkbox"
            name="icuAvailable"
            defaultChecked={facilities?.icuAvailable}
            className="h-5 w-5"
          />
        ...
        <div className="flex items-center gap-3">
          <input
            type="checkbox"
            name="nicuAvailable"
            defaultChecked={facilities?.nicuAvailable}
            className="h-5 w-5"
          />
        ...
        <div className="flex items-center gap-3">
          <input
            type="checkbox"
            name="emergency24x7"
            defaultChecked={facilities?.emergency24x7}
            className="h-5 w-5"
          />
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            defaultChecked={facilities?.ambulanceAvailable}
            className="h-5 w-5"
          />
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            defaultChecked={facilities?.pharmacyAvailable}
            className="h-5 w-5"
          />
        ...
        <div className="flex items-center gap-3">
          <input
            type="checkbox"
            name="labAvailable"
            defaultChecked={facilities?.labAvailable}
            className="h-5 w-5"
          />
