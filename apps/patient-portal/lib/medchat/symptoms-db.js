...
export const RED_FLAGS = [
  ...
  {
    pattern: /not breathing|can'?t breathe|severe breathing|respiratory arrest/i,
    label: 'Severe breathing difficulty',
  },
  { pattern: /blue\s?lips|cyanosis|bluish/i, label: 'Cyanosis (bluish lips)' },
  {
    pattern: /persistent vomiting.{0,20}lethargy|lethargy.{0,20}persistent vomiting/i,
    label: 'Persistent vomiting with lethargy',
  },
  { pattern: /altered sensorium|confused.{0,15}disoriented|delirium/i, label: 'Altered sensorium' },
  {
    pattern: /severe dehydration|sunken eyes.{0,20}dry mouth|no tears.{0,15}dry/i,
  ...
  {
    pattern: /continuous crying.{0,20}(poor|not) respon/i,
    label: 'Continuous crying with poor responsiveness (pediatric)',
  },
  {
    pattern: /stroke|paralysis.{0,15}sudden|sudden.{0,15}paralysis|face drooping/i,
...
export const PEDIATRIC_RULES = {
  ...
  infantEscalationTriggers: [
    ...
    {
      pattern: /poor feeding|not feeding|refusing feed/i,
      label: 'Poor feeding in infant',
      riskBoost: 30,
    },
    {
      pattern: /excessive sleep|letharg|drowsy|sleepy/i,
      label: 'Excessive sleepiness in infant',
      riskBoost: 30,
    },
  ...
  childEscalationTriggers: [
    ...
    {
      pattern: /persistent.{0,10}(high )?fever/i,
      label: 'Persistent high fever in child',
      riskBoost: 20,
    },
    {
      pattern: /fast breath|rapid breath|chest (indraw|retract)/i,
      label: 'Respiratory distress in child',
      riskBoost: 25,
    },
  ],
};
...
export const SYMPTOM_MAP = [
  ...
  // Dermatology
  {
    ...
    category: 'Dermatological symptoms',
    riskWeight: 6,
  },
  ...
  {
    patterns: [
      /ear\s?(pain|ache|infection)/i,
      /sore throat|throat pain/i,
      /running nose|nasal/i,
      /sinus/i,
      /hearing/i,
      /tonsil/i,
    ],
    speciality: 'ENT (Otolaryngology)',
    category: 'Ear, Nose & Throat symptoms',
    riskWeight: 8,
  },
  ...
  // Gynecology
  {
    patterns: [
      ...
      /pregnan/i,
      /pelvic pain/i,
      /breast\s?(pain|lump)/i,
    ],
    speciality: 'Gynecology',
    category: 'Gynecological symptoms',
    riskWeight: 14,
  },
  ...
  // Endocrinology
  {
    ...
    category: 'Endocrine / metabolic symptoms',
    riskWeight: 12,
  },
  ...
  // Emergency Medicine
  {
    ...
    category: 'Trauma / Emergency symptoms',
    riskWeight: 22,
  },
];
...
export const LOCAL_RISKS = {
  Hyderabad: {
    dengueStatus: 'HIGH',
    malariaStatus: 'MEDIUM',
    alert: 'Seasonal fever spike reported',
  },
  Delhi: {
    pollutionStatus: 'CRITICAL',
    respiratoryRisk: 2.0,
    alert: 'High AQI - Respiratory caution',
  },
...
export const JAILBREAK_RESPONSE = {
  ...
  clinical_summary_for_doctor:
    'Patient input contained non-clinical content. No valid symptoms could be extracted for triage. Recommend standard consultation to assess patient needs.',
  patient_advice:
    'MedChat AI is designed to help you describe your symptoms so we can guide you to the right doctor. For medical advice, diagnosis, or prescriptions, please consult a qualified healthcare professional directly. You can book an appointment through Haspataal.',
  disclaimer:
