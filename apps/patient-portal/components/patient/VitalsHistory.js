    ...
    <div className="space-y-6">
      {vitals
        ...
        .map((vital) => (
          <Card
            key={vital.id}
            className="group hover:border-rose-200 hover:shadow-2xl hover:shadow-rose-500/5 transition-all duration-500 rounded-[2.5rem] bg-white border-slate-200/60 overflow-hidden relative"
          >
            <CardContent className="p-0">
              <div className="flex items-center justify-between px-8 py-5 bg-slate-50/50 border-b border-slate-100 group-hover:bg-rose-50/30 transition-colors">
                ...
                <Badge
                  variant="outline"
                  className="text-[9px] font-black uppercase tracking-widest px-3 py-1 rounded-lg border-slate-200 text-slate-400"
                >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
                  {vital.weight && (
                    <div className="space-y-1">
                      ...
                      <div className="text-xl font-black text-slate-900 tracking-tight">
                        {vital.weight}
                        <span className="text-xs font-bold text-slate-300 ml-1">kg</span>
                      </div>
                    </div>
                  )}
                  {vital.bloodPressure && (
                  ...
                  {vital.bloodSugar && (
                    <div className="space-y-1">
                      ...
                      <div className="text-xl font-black text-slate-900 tracking-tight">
                        {vital.bloodSugar}
                        <span className="text-xs font-bold text-slate-300 ml-1">mg/dL</span>
                      </div>
                    </div>
                  )}
                  {vital.spo2 && (
