        ...
        <div className="flex flex-col md:flex-row items-center gap-8 p-8 relative">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto pt-4 md:pt-0">
            <Button
              asChild
              variant="outline"
              className="h-12 px-6 rounded-xl border-slate-200 font-bold text-slate-700 hover:bg-slate-50 gap-2 transition-all active:scale-95"
            >
            ...
            <Button
              asChild
              className="h-12 px-8 rounded-xl bg-blue-600 hover:bg-blue-700 font-bold shadow-lg shadow-blue-500/20 gap-2 transition-all active:scale-95"
            >
