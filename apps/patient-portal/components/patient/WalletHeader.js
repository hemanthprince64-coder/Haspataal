      ...
      <div className="relative h-64 bg-slate-900 rounded-[2.5rem] p-10 text-white overflow-hidden shadow-2xl transition-all duration-500 hover:scale-[1.01]">
        ...
        <div className="relative z-10 h-full flex flex-col">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
            <div>
              <div className="text-[11px] font-black uppercase tracking-[0.3em] text-blue-300 mb-2">
                Available Balance
              </div>
              <div className="flex items-baseline gap-2">
                <span className="text-5xl font-black tracking-tighter tabular-nums drop-shadow-2xl">
                  ₹{balance}
                </span>
