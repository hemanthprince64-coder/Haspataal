  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      {medications.map((med) => (
        <Card
          key={med.id}
          className="group hover:border-violet-300 hover:shadow-2xl hover:shadow-violet-500/10 transition-all duration-500 rounded-[2rem] bg-white border-slate-200/60 overflow-hidden"
        >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <Badge
                        variant="secondary"
                        className="bg-emerald-50 text-emerald-700 hover:bg-emerald-50 border-0 text-[9px] font-black uppercase tracking-widest px-2 py-0.5 rounded-md"
                      >
                        Active
                      </Badge>
