      ...
      <div className="flex justify-between items-start mb-10">
        <div>
          ...
          <p className="text-slate-500 mt-2 text-lg">
            Hospital performance vs. Network benchmarks.
          </p>
        </div>
        ...
        <Card className="shadow-2xl border-0 bg-white">
          ...
          <CardContent className="pt-2">
            <div className="space-y-6">
              {[
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <p
                      className={`text-[10px] font-bold ${doc.trend === 'up' ? 'text-emerald-500' : 'text-amber-500'}`}
                    >
              ...
              <Button
                variant="ghost"
                className="w-full text-xs text-blue-600 hover:bg-blue-50 font-bold uppercase tracking-tighter"
              >
          ...
          <div className="relative z-10 flex flex-col h-full justify-between">
            <div>
              ...
              <p className="text-slate-400 text-sm leading-relaxed max-w-sm">
                We only win when you win. Our model tracks the incremental revenue generated by our
                retention engine.
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex justify-between items-center p-4 bg-slate-50 rounded-2xl border border-slate-100">
              ...
              <span className="text-lg font-black text-slate-900">
                4.1% <span className="text-xs text-emerald-500 ml-2">▼ Top 10%</span>
              </span>
            </div>
            <div className="flex justify-between items-center p-4 bg-slate-50 rounded-2xl border border-slate-100">
              <span className="text-sm font-bold text-slate-600">Revenue per Bed/Day</span>
              <span className="text-lg font-black text-slate-900">
                ₹12.4K <span className="text-xs text-blue-500 ml-2">▲ Avg: ₹8.2K</span>
              </span>
            </div>
          </div>
        </Card>
