      ...
      <div className="flex justify-between items-center mb-10">
        <div>
          ...
          <p className="text-slate-500">
            Track your referrals, hospital activations, and commissions.
          </p>
        </div>
                ...
                {[
                  ...
                  <tr key={i} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="px-8 py-6">
                      <span
                        className={`px-3 py-1 rounded-full text-xs font-bold ${row.status === 'Activated' ? 'bg-emerald-100 text-emerald-700' : 'bg-amber-100 text-amber-700'}`}
                      >
                        {row.status}
                      </span>
                    </td>
                    ...
                    <td className="px-8 py-6 text-right">
                      <Button variant="ghost" className="text-blue-600 hover:bg-blue-50 font-bold">
                        View Details
                      </Button>
                    </td>
                  </tr>
