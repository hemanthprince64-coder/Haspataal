    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {doctors.map((doc: any, i: number) => {
          const docTiming = timings[doc.name] || {
            slotDuration: '15',
          ...
          return (
            <div
              key={i}
              className="flex flex-col md:flex-row gap-3 md:gap-4 items-start md:items-center bg-white p-4 rounded-lg border shadow-sm"
            >
