      ...
      <div className="flex flex-col gap-4">
        {doctors.length > 0 ? (
          doctors.map((doc) => (
            <div
              key={doc.id}
              className="bg-gray-900 border border-gray-800 rounded-2xl p-6 flex items-center justify-between hover:border-cyan-500/30 transition-shadow transition-all hover:scale-[1.01]"
            >
              ...
              <div className="flex flex-col items-end gap-2 text-right">
                <div>
                  ...
                  <p className="text-white font-bold inline-flex items-center">
                    ₹500{' '}
                    <span className="ml-1 text-[10px] text-gray-600 font-normal">(Instant)</span>
                  </p>
                </div>
