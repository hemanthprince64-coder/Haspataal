    ...
    <div className="min-h-[calc(100vh-64px)] flex flex-col items-center justify-center py-16 px-4 bg-slate-50 relative overflow-hidden">
      ...
      <div className="max-w-4xl w-full text-center z-10 space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-1000">
        <div className="space-y-6">
          ...
          <h1 className="text-senior-h1 tracking-tight text-slate-900 drop-shadow-sm">
            Hospital Partner Portal
          </h1>
          <p className="text-xl text-slate-500 max-w-2xl mx-auto leading-relaxed font-medium">
            Empower your medical facility with Haspataal. Digitize your OPD, manage staff
            efficiently, and grow your clinical presence.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
          <Button
            asChild
            size="lg"
            className="btn-medical min-w-[200px] h-14 text-base shadow-lg shadow-blue-200/50 group"
          >
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="min-w-[200px] h-14 text-base border-slate-200 hover:bg-slate-100 hover:text-blue-600 transition-all group bg-white/80"
          >
        ...
        <div className="pt-16">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <Card
                key={f.title}
                className={`card-clinical border-none shadow-sm hover:shadow-md transition-all duration-300 animate-in fade-in slide-in-from-bottom-4 delay-${(i + 1) * 100}`}
              >
