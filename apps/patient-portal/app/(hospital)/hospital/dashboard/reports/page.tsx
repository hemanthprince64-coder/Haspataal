    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex items-center gap-3">
          <Badge
            variant="outline"
            className="px-3 py-1 text-xs bg-white shadow-sm font-bold border-slate-200"
          >
        ...
        <div className="bg-white rounded-3xl border-2 border-dashed border-slate-200 p-20 text-center space-y-4">
          ...
          <div className="max-w-xs mx-auto">
            ...
            <p className="text-sm text-slate-400">
              Clinical records will appear here once patient visits are completed through the
              billing portal.
            </p>
          </div>
        </div>
              ...
              {visits.map((v) => (
                <tr key={v.id} className="hover:bg-slate-50/50 transition-colors group">
                  ...
                  <td className="px-6 py-4 text-center">
                    <span
                      className={`px-2 py-1 rounded-full text-[9px] font-black tracking-widest inline-block border
                                          ${
                                            v.status === 'COMPLETED'
