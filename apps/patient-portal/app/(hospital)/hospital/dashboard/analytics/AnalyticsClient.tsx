    ...
    <div className="space-y-6">
          ...
          {revenue?.breakdown?.map((item: any) => (
            <div key={item.label} className="relative pt-1">
              ...
              <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-emerald-100">
                <div
                  style={{
                    width: `${Math.max(10, Math.min(100, (item.amount / revenue.totalRecovered) * 100))}%`,
                  }}
      ...
      <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-1">
            <span className="text-[10px] text-gray-400 font-bold uppercase tracking-tighter self-center mr-2">
              Intensity:
            </span>
            {[1, 2, 3, 4, 5].map((i) => (
              <div
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-slate-900 p-6 rounded-2xl text-white relative overflow-hidden">
          ...
          <h4 className="text-sm font-bold text-teal-400 uppercase tracking-widest mb-4">
            AI Prediction
          </h4>
          <p className="text-lg font-medium leading-relaxed mb-6">
            Based on current growth, your hospital is projected to hit{' '}
            <span className="text-teal-400 font-bold">₹12.4L</span> in recovery revenue by Q3.
          </p>
        ...
        <div className="bg-emerald-50 p-6 rounded-2xl border border-emerald-100">
          <h4 className="text-sm font-bold text-emerald-800 uppercase tracking-widest mb-4">
            Patient Retention
          </h4>
