  ...
  if (user.status !== 'ACTIVE') {
    return (
      <div
        ...
        style={{ padding: '4rem 1rem', display: 'flex', justifyContent: 'center' }}
      >
        <div
          className="card"
          style={{ maxWidth: '500px', width: '100%', textAlign: 'center', padding: '3rem 2rem' }}
        >
          <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>⏳</div>
          <h2 style={{ marginBottom: '1rem', fontWeight: '800' }}>Account Pending Approval</h2>
          <p style={{ color: 'var(--text-muted)' }}>
            Your partner account is currently being reviewed by an administrator. You will be able
