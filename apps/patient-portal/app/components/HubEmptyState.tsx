  ...
  return (
    <div className="mt-12 p-12 bg-gray-900/40 border border-gray-800 rounded-3xl text-center backdrop-blur-xl">
      ...
      <h3 className="text-2xl font-bold text-white mb-3">
        No {specialty} found in {city}
      </h3>
      <p className="text-gray-400 max-w-md mx-auto mb-8 leading-relaxed">
        We couldn&apos;t find any verified specialists matching your criteria in this location. Our
        team is working on onboarding more partners in {city} soon.
      </p>
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        <Link
          href="/"
          className="px-8 py-3 bg-white text-black font-bold rounded-2xl hover:bg-gray-200 transition-all shadow-xl"
        >
          Back to Home
        </Link>
        <Link
          href="/doctors"
          className="px-8 py-3 bg-gray-800 text-white font-bold rounded-2xl border border-gray-700 hover:bg-gray-700 transition-all"
        >
          View All Doctors
        </Link>
      </div>
