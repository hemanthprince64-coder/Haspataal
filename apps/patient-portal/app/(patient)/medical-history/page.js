      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
        <div>
          ...
          <p className="text-slate-500 text-lg font-medium tracking-tight">
            Structured baseline data for personalized care orchestration.
          </p>
        </div>
      ...
      <Card className="mb-12 rounded-[2.5rem] bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-700 border-none p-1 flex items-center overflow-hidden shadow-2xl shadow-blue-500/20 group">
        <CardContent className="w-full bg-white/95 backdrop-blur-sm rounded-[2.35rem] p-8 md:p-12 flex flex-col md:flex-row items-center gap-10 relative overflow-hidden">
          ...
          <div className="flex-1 text-center md:text-left">
            <h3 className="text-3xl font-black text-slate-900 tracking-tight mb-2 uppercase">
              Clinical Baseline
            </h3>
            <p className="text-slate-500 text-lg font-medium tracking-tight mb-0">
              Updating your history ensures that all cross-consultations are safe and drug
              interactions are automatically flagged.
            </p>
          </div>
        </CardContent>
      </Card>
          ...
          <Card className="md:col-span-2 rounded-[3.5rem] border-rose-200 bg-rose-50/30 overflow-hidden shadow-xl shadow-rose-500/5 group hover:border-rose-400 transition-all">
            <CardContent className="p-10 space-y-6">
              <div className="flex items-center gap-4 text-rose-600">
                ...
                <div>
                  <h3 className="text-2xl font-black tracking-tight mb-0">
                    Drug Allergies & Sensitivities
                  </h3>
                  <Badge
                    variant="outline"
                    className="mt-1 border-rose-200 text-rose-700 font-black text-[10px] uppercase tracking-widest px-3 py-1 bg-white/50"
                  >
              ...
              <div className="flex items-center gap-3 text-rose-400/60 font-bold text-xs uppercase tracking-widest px-2">
                <ShieldAlert className="w-4 h-4" /> This data is shared with every consultant
                automatically
              </div>
            </CardContent>
          </Card>
