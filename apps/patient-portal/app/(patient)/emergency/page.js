      ...
      <div className="relative z-10 flex flex-col h-full flex-grow">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 pb-20">
          ...
          <div className="relative group mb-16">
            ...
            >
              <div
                className={`p-6 rounded-full bg-rose-50 mb-4 transition-transform duration-500 ${calling ? 'scale-110' : ''}`}
              >
                <ShieldAlert
                  className={`w-16 h-16 text-rose-600 ${calling ? 'animate-pulse' : ''}`}
                />
              </div>
          ...
          <div className="w-full max-w-sm space-y-4">
            ...
            <Card className="rounded-[2rem] border-none bg-white/10 backdrop-blur-xl group hover:bg-white/20 transition-all cursor-pointer">
              <CardContent className="p-6 flex items-center justify-between">
                ...
                <a
                  href="tel:108"
                  className="h-12 w-12 bg-white rounded-xl flex items-center justify-center text-rose-600 font-black shadow-lg hover:scale-110 active:scale-95 transition-all"
                >
