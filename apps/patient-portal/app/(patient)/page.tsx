...
export default function PatientHome() {
  ...
  const infoValues = [
    ...
    {
      title: 'Accessibility',
      description: 'Easy access to healthcare services, records, and support anytime, anywhere',
    ...
    <div className="flex flex-col gap-8 pt-6 pb-24 animate-fade-in container mx-auto px-4 max-w-6xl">
      ...
      <section className="relative pt-12 pb-20 md:pt-20 md:pb-32 overflow-hidden rounded-[2.5rem] bg-slate-50 border border-slate-200 shadow-sm mt-2">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 max-w-4xl mx-auto">
          <Badge
            variant="secondary"
            className="mb-8 px-4 py-1.5 text-blue-700 bg-blue-100/50 hover:bg-blue-100/80 rounded-full text-sm font-medium border border-blue-200 backdrop-blur-md cursor-default transition-colors"
          >
          ...
          <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-2xl leading-relaxed">
            Haspataal is transforming patient care. Search real-time availability, compare verified
            reviews, and book confirmed appointments across top-rated medical facilities instantly.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-5 w-full sm:w-auto justify-center">
            <Button
              asChild
              size="lg"
              className="h-14 px-8 text-base font-semibold rounded-2xl bg-slate-900 text-white hover:bg-slate-800 shadow-xl shadow-slate-900/20 transition-all hover:-translate-y-1 duration-300"
            >
              <Link href="/search">
          ...
          <div className="mt-16 grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-12 w-full max-w-3xl border-t border-slate-200 pt-10">
            <div className="flex flex-col items-center justify-center p-2 group cursor-default">
              ...
              <span className="text-sm font-semibold text-slate-700 leading-tight text-center">
                Verified
                <br />
                Specialists
              </span>
      ...
      <section className="py-12 mt-12 bg-white rounded-[2rem] border border-slate-100 shadow-sm px-6 sm:px-10">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 gap-4">
          <div>
            <Badge
              variant="outline"
              className="mb-3 text-blue-600 border-blue-200 uppercase tracking-widest px-3 py-1 text-xs bg-blue-50/50"
            >
              Featured
            </Badge>
          ...
          <Button
            asChild
            variant="outline"
            className="text-blue-600 border-blue-200 hover:bg-blue-50 font-semibold h-11 px-6 rounded-xl hidden sm:inline-flex"
          >
        ...
        <Button
          asChild
          variant="outline"
          className="w-full mt-6 text-blue-600 border-blue-200 hover:bg-blue-50 font-semibold h-12 rounded-xl sm:hidden"
        >
          <Link href="/search">See All Specialists &rarr;</Link>
        </Button>
      </section>
