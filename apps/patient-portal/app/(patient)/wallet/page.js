    ...
    <main className="container max-w-4xl mx-auto px-6 py-10 animate-fade-in">
      ...
      <div className="mb-10">
        <div className="flex items-center gap-2 mb-3">
          <Badge
            variant="secondary"
            className="text-emerald-700 bg-emerald-100/50 hover:bg-emerald-100 border-emerald-200 px-3 py-1 font-bold text-[10px] uppercase tracking-[0.2em] backdrop-blur-sm"
          >
        ...
        <p className="text-slate-500 text-lg font-medium tracking-tight">
          Manage your credits and instant booking funds.
        </p>
      </div>
      ...
      <div className="space-y-8">
        {loading ? (
          ...
          <WalletHeader balance={balance} onTopUp={() => setShowTopUpOptions(!showTopUpOptions)} />
        )}
            ...
            <CardContent className="p-8">
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
                {[500, 1000, 2000, 5000].map((amt) => (
                  ...
                  >
                    <div className="text-[10px] font-black text-slate-300 uppercase tracking-widest mb-1 group-hover:text-blue-400 transition-colors">
                      Amount
                    </div>
                    <div className="font-black text-2xl text-slate-700 group-hover:text-blue-600 group-hover:scale-110 transition-all">
                      ₹{amt}
                    </div>
              ...
              <div className="flex flex-col items-center gap-6">
                <div className="text-[10px] font-black text-slate-300 uppercase tracking-widest flex items-center gap-3 w-full">
                  <div className="h-px flex-1 bg-slate-100" /> Authorized Payment Methods{' '}
        ...
        <Card className="rounded-[2.5rem] border-slate-200/60 shadow-xl shadow-slate-200/10 bg-white overflow-hidden">
          <CardHeader className="p-8 border-b border-slate-100 bg-slate-50/30">
            <div className="flex items-center justify-between">
              ...
              <Badge
                variant="outline"
                className="text-slate-400 font-bold px-3 py-1 rounded-lg border-slate-200"
              >
