  ...
  return (
    <main className="container max-w-5xl mx-auto px-4 py-8 animate-fade-in">
      <div className="mb-8">
        <Badge
          variant="secondary"
          className="mb-3 text-blue-700 bg-blue-100 hover:bg-blue-100 px-3 py-1 font-bold uppercase tracking-widest text-[9px] border-blue-200"
        >
      ...
      <Card className="mb-8 p-1.5 border-slate-200/60 shadow-xl shadow-slate-200/10 rounded-2xl overflow-hidden bg-white/80 backdrop-blur-xl sticky top-4 z-50 ring-1 ring-slate-200/50">
        ...
        >
          ...
          {speciality && (
            <input type="hidden" name="speciality" value={speciality} suppressHydrationWarning />
          )}
