      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-12">
        <div>
          ...
          <p className="text-slate-500 text-lg font-medium tracking-tight">
            Access your digital scripts and manage secondary pharmacy uploads.
          </p>
        </div>
        ...
        <div className="relative group">
          ...
          {!isUploading && (
            <p className="text-[10px] text-center text-slate-400 mt-2 font-black uppercase tracking-[0.2em]">
        ...
        <CardContent className="w-full bg-white/95 backdrop-blur-sm rounded-[1.85rem] p-6 flex items-center gap-6 relative overflow-hidden">
          ...
          <div className="flex-1">
            <p className="text-slate-600 font-bold leading-relaxed">
              <span className="text-blue-600 font-black uppercase tracking-widest text-[10px] block mb-1">
                Encrypted Storage
              </span>
              All prescriptions are stored in a secure, HIPAA-compliant vault. Only you and
              authorized doctors can access them.
            </p>
          </div>
        </CardContent>
      </Card>
