  ...
  return (
    <>
      <div
        ...
        style={{ padding: '32px 20px 24px', textAlign: 'left', background: 'var(--navy)' }}
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '8px' }}>
          <Link href="/search" style={{ color: 'white', textDecoration: 'none', fontSize: '24px' }}>
            ←
          </Link>
        ...
        <div style={{ display: 'flex', gap: '16px', marginBottom: '24px' }}>
          <div
            ...
            style={{
              ...
              cursor: 'pointer',
              border:
                selectedType === 'clinic' ? '2px solid var(--blue)' : '1px solid var(--grey2)',
