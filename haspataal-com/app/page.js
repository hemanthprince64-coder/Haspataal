          ...
          <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
            ...
            <div className="flex-1 max-w-2xl animate-fade-in-up">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 leading-[1.1] mb-6 tracking-tight">
                Complete <span className="text-sky-600">Healthcare</span>{' '}
                <br className="hidden lg:block" />
                <span className="text-teal-600">Protection</span> for Your{' '}
                <br className="hidden lg:block" />
                Family
              </h1>

              <p className="text-lg md:text-xl text-slate-600 leading-relaxed mb-10 max-w-lg font-medium">
                Connect with top doctors, diagnostic centers, and hospitals near you. Secure health
                records and reliable assistance at every step.
              </p>

              <div className="flex flex-wrap gap-4">
                <Link
                  href="/search"
                  className="btn bg-sky-600 hover:bg-sky-700 text-white shadow-lg shadow-sky-200/50 text-lg px-8 py-4 rounded-xl font-bold transition-all transform hover:-translate-y-1"
                >
                  Find Doctors
                </Link>
                <Link
                  href="/hospitals"
                  className="btn border-2 border-slate-300 text-slate-700 hover:border-slate-400 hover:bg-slate-50 text-lg px-8 py-4 rounded-xl font-semibold transition-all"
                >
                  View Hospitals
                </Link>
              </div>
      ...
      <section className="container" style={{ padding: '5rem 1rem' }}>
        ...
        >
          {specialities.map((spec) => (
            <Link
              href={`/search?speciality=${spec.name}`}
              key={spec.name}
              className="card card-interactive"
              style={{
                padding: '1.5rem 1rem',
