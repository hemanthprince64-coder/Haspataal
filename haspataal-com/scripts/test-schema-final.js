...
async function main() {
  ...
  try {
    ...
    console.log(
      `🔍 Doctor Reviews: ${doctorWithReviews.reviews.length} (Last: ${doctorWithReviews.reviews[0].comment})`,
    );
    ...
    console.log(
      `🔍 Hospital Reviews: ${hospitalWithReviews.reviews.length} (Last: ${hospitalWithReviews.reviews[0].comment})`,
    );
  } catch (e) {
