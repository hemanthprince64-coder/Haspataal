    ...
    <main className="container max-w-6xl mx-auto px-6 py-12 animate-fade-in text-slate-900">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
        <div>
          ...
          <h1 className="text-6xl font-black tracking-tighter mb-4 text-slate-900 leading-none">
            Get in touch.
          </h1>
          <p className="text-slate-500 text-xl font-medium tracking-tight max-w-xl">
            We’re here to assist you with everything from clinical triage to appointment
            coordination.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
        ...
        <Card className="lg:col-span-3 rounded-[3rem] border-slate-200 shadow-2xl shadow-slate-200/40 bg-white overflow-hidden">
          <CardHeader className="p-10 pb-0">
            ...
            <CardDescription className="text-slate-500 text-lg font-medium tracking-tight mt-2">
              Expect a clinical response within 15 minutes during business hours.
            </CardDescription>
          </CardHeader>
          <CardContent className="p-10 pt-8">
            {status === 'success' ? (
              <div className="bg-emerald-50 border border-emerald-100 rounded-[2rem] p-12 text-center animate-in zoom-in-95 duration-500">
                ...
                <p className="text-emerald-700 text-lg font-medium opacity-80">
                  Our care team has received your inquiry and will reach out shortly.
                </p>
                <Button
                  variant="ghost"
                  className="mt-8 font-black text-sm uppercase tracking-widest text-emerald-600 hover:bg-emerald-100"
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <Button className="w-full h-18 rounded-[2rem] bg-slate-900 border-2 border-slate-900 hover:bg-slate-800 text-white font-black text-xl shadow-2xl shadow-slate-900/20 transition-all active:scale-95 group">
                  Send Message{' '}
        ...
        <div className="lg:col-span-2 space-y-8">
          <Card className="rounded-[2.5rem] bg-slate-900 text-white border-none p-10 shadow-2xl overflow-hidden relative group">
            ...
            <div className="relative z-10 space-y-8">
              <div className="space-y-2">
                <Badge className="bg-blue-500 text-white font-black text-[9px] uppercase tracking-widest px-3 py-1 rounded-lg border-none">
                  Global HQ
                </Badge>
              ...
              <Button
                variant="outline"
                className="w-full h-14 border-white/20 text-white hover:bg-white/10 rounded-2xl font-black text-xs uppercase tracking-widest"
              >
            ...
            <div className="space-y-6 text-center">
              ...
              <div>
                ...
                <p className="text-slate-500 font-medium">
                  Browse our most frequently asked clinical and technical questions.
                </p>
              </div>
              <Button
                variant="ghost"
                className="font-black text-blue-600 uppercase tracking-widest text-[10px] hover:bg-blue-50"
              >
          ...
          <Card className="rounded-[2.5rem] bg-rose-50 border-rose-100 p-8 flex items-center gap-6 relative overflow-hidden group">
            ...
            <div>
              <h4 className="text-lg font-black text-rose-900 tracking-tight leading-none mb-1">
                Emergency SOS
              </h4>
              <p className="text-xs font-bold text-rose-700 opacity-70 mb-0">
                Direct 24x7 bypass to crisis management
              </p>
              <Link
                href="/emergency"
                className="text-[10px] font-black text-rose-600 uppercase tracking-widest mt-2 inline-block hover:underline"
              >
                Launch Protocol →
              </Link>
            </div>
