        ...
        <main className="container page-enter" style={{ padding: "2rem 1rem" }}>
            <div style={{ marginBottom: "2rem" }}>
                ...
                <p style={{ color: "var(--text-muted)" }}>
                    {doctorsWithHospitals.length} {doctorsWithHospitals.length === 1 ? 'doctor' : 'doctors'} available for consultation
                </p>
            </div>
                    ...
                    {doctorsWithHospitals.map(doc => (
                        <div key={doc.id} className="card card-interactive" style={{ padding: "1.5rem", display: "flex", gap: "1rem" }}>
                            ...
                            <div style={{ flex: 1 }}>
                                ...
                                <p style={{ color: "var(--text-muted)", fontSize: "0.8rem", marginTop: "0.5rem", marginBottom: "0.75rem" }}>🏥 {doc.hospital?.name} • 📍 {doc.hospital?.area}, {doc.hospital?.city}</p>
                                <div style={{ display: "flex", gap: "1rem", fontSize: "0.8rem", marginBottom: "1rem" }}>
                                    <span style={{ color: "var(--text-muted)" }}>⭐ {doc.hospital?.rating || "4.5"}</span>
