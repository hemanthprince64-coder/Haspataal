    ...
    return (
        <div style={{ padding: "4rem 1rem", textAlign: "center", maxWidth: "600px", margin: "0 auto" }}>
            ...
            <div className="animate-fade-in-up delay-1" style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
                <Link href="/hospital/login" className="btn btn-primary btn-lg" style={{ minWidth: "180px" }}>
                    ⬆️ Login
                </Link>
                <Link href="/hospital/register" className="btn btn-outline btn-lg" style={{ minWidth: "180px" }}>
                    ✨ Register Hospital
                </Link>
            </div>
