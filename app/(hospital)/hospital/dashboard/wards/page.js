...
export default async function WardsPage() {
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "60vh", textAlign: "center", padding: "2rem" }}>
            ...
            <h1 style={{ fontSize: "2rem", fontWeight: "800", color: "#0f172a", marginBottom: "0.5rem" }}>IPD / Ward Management</h1>
            <p style={{ color: "#64748b", maxWidth: "400px", fontSize: "1.1rem" }}>Bed occupancy tracking, admission workflows, and discharge summaries coming soon.</p>
