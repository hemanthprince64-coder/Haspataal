    ...
    return (
      <div style={{ padding: '4rem 1rem', display: 'flex', justifyContent: 'center' }}>
        <div
          ...
          style={{ maxWidth: '420px', width: '100%', textAlign: 'center', padding: '2.5rem' }}
        >
          <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>🎉</div>
          <h2 style={{ color: 'var(--success)', marginBottom: '0.5rem', fontWeight: '700' }}>
    ...
    <div style={{ padding: '3rem 1rem', display: 'flex', justifyContent: 'center' }}>
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          >
            Partner/Agent Registration
          </h2>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>
            Join Haspataal&apos;s network to onboard hospitals and patients.
          </p>
        </div>
        ...
        <div style={{ textAlign: 'center' }}>
          <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)' }}>
            Already registered?{' '}
            <Link href="/agent/login" style={{ color: 'var(--primary)', fontWeight: '600' }}>
              Login here →
            </Link>
          </p>
        </div>
